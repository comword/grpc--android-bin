...
set_target_properties(gRPC::gpr PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "dl;m;gRPC::absl_base;gRPC::absl_memory;gRPC::absl_status;gRPC::absl_str_format;gRPC::absl_strings;gRPC::absl_synchronization;gRPC::absl_time;gRPC::absl_optional;gRPC::upb;android;log"
)
...
set_target_properties(gRPC::grpc PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::zlibstatic;gRPC::cares;gRPC::address_sorting;gRPC::re2;gRPC::upb;dl;m;gRPC::absl_flat_hash_map;gRPC::absl_inlined_vector;gRPC::absl_bind_front;gRPC::absl_statusor;gRPC::gpr;gRPC::ssl;gRPC::crypto;gRPC::address_sorting"
)
...
set_target_properties(gRPC::grpc_unsecure PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::zlibstatic;gRPC::cares;gRPC::address_sorting;gRPC::re2;gRPC::upb;dl;m;gRPC::absl_flat_hash_map;gRPC::absl_inlined_vector;gRPC::absl_statusor;gRPC::gpr;gRPC::address_sorting"
)
...
set_target_properties(gRPC::grpc++ PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libprotobuf-lite;dl;m;gRPC::grpc"
)
...
set_target_properties(gRPC::grpc++_unsecure PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libprotobuf-lite;dl;m;gRPC::grpc_unsecure"
)
...
set_target_properties(gRPC::grpc_plugin_support PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libprotobuf-lite;dl;m"
)
...
foreach(_target "protobuf::libprotobuf-lite" )
